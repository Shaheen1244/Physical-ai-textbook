...
Imitation learning, also known as learning from demonstration, involves learning a policy (mathematical expression) that mimics expert behavior demonstrated through trajectories (mathematical expression). The fundamental assumption is that expert demonstrations provide high-quality examples of desired behavior.

The imitation learning problem can be formulated as:

(Mathematical optimization expression)

where (mathematical expression) is the Kullback-Leibler divergence and (mathematical expression) represents the state distribution under expert demonstrations.

<!-- ![Figure 8.1: Imitation Learning Framework](/img/physical-ai/imitation-learning-framework.svg) -->
<!-- TODO: Create imitation-learning-framework.svg image for this chapter -->
